...
class DatabaseHelper {
  ...
  static const _databaseVersion = 1; // _onUpgrade - increment
  ...
  Future<int> insertStudentDetails(Map<String, dynamic> row,
  ...
  Future<int> updateStudentDetails(Map<String, dynamic> row,
      String tableName) async {
    int id = row[colId];
